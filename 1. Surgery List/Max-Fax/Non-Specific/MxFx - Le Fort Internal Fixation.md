...
>>>>- If the [[Signature Drill Set]] is unavailable, use the [[TPS Oral Drill & Saw Tray]] and [[TPS Drill Console]] instead.
...
|  1  | [[Signature Drill Set]]                 | `=[[Signature Drill Set]].location`                 |                                         |
|  1  | [[Facial Fracture Tray]]                | `=[[Facial Fracture Tray]].location`                |                                         |
|  1  | [[Maxillo-Facial Osteotomy Tray - Old]] | `=[[Maxillo-Facial Osteotomy Tray - Old]].location` | New if unavailable                      |
>>>>
>>>
>>><br>
>>>
...
|  #  | Instruments                            | Location                                            | Note                                    |
|:---:|:--------------------------------------- |:--------------------------------------------------- |:--------------------------------------- |
|  1  | [[Leibinger 1.2mm and 1.7mm Tray]]      | `=[[Leibinger 1.2mm and 1.7mm Tray]].location`      |                                         |
|  1  | [[Leibinger 2.0mm Tray]]                | `=[[Leibinger 2.0mm Tray]].location`                |                                         |
|  1  | [[Third Molar Set]]                     | `=[[Third Molar Set]].location`                    |                                         |
>>>
>>
>
>>[!MxFx] Max-Fax Trolley
...
|  #  | Instruments                         | Location                                        | Note |
|:---:| ----------------------------------- | ----------------------------------------------- | ---- |
|  1  | [[Ochsner Artery Forceps - Curved]] | `=[[Ochsner Artery Forceps - Curved]].location` |      |
|  1  | [[Pickling Fork]]                   | `=[[Pickling Fork]].location`                   |      |
|  1  | [[Rowes Disimpaction Forceps]]      | `=[[Rowes Disimpaction Forceps]].location`      |      |
|  1  | [[Smith Ramus Separator]]           | `=[[Smith Ramus Separator]].location`           |      |
|  1  | [[Smith Sagittal Split Separator]]  | `=[[Smith Sagittal Split Separator]].location`  |      |
>>>
>>>>[!Supply] Supplies
|  #  | Supplies                              | Location                                          | Note                                                                                                             |
|:---:| ------------------------------------- | ------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
|  1  | [[SD - Fissure Drill Bit 1.2mm]]      | `=[[SD - Fissure Drill Bit 1.2mm]].location`      | `=[[SD - Fissure Drill Bit 1.2mm]].Restock`                                                                      |
|  1  | [[SD - Fissure Drill Bit 1.6mm]]      | `=[[SD - Fissure Drill Bit 1.6mm]].location`      | `=[[SD - Fissure Drill Bit 1.6mm]].Restock`                                                                      |
|  1  | [[SD - Lindemann Drill Bit 2.2mm]]    | `=[[SD - Lindemann Drill Bit 2.2mm]].location`    | `=[[SD - Lindemann Drill Bit 2.2mm]].Restock`                                                                    |
|  1  | [[SD - Round Fluted Drill Bit 1.0mm]] | `=[[SD - Round Fluted Drill Bit 1.0mm]].location` | `=[[SD - Round Fluted Drill Bit 1.0mm]].Restock`                                                                 |
|  1  | [[SD - Round Fluted Drill Bit 2.0mm]] | `=[[SD - Round Fluted Drill Bit 2.0mm]].location` | `=[[SD - Round Fluted Drill Bit 2.0mm]].Restock`                                                                 |
|  1  | [[Smoke Chain]]                       | `=[[Smoke Chain]].location`                       | **==Please include in surgical count.==**<br>**==Take note if trimmed, and add it to the count as necessary.==** |
>>>>
...
|  1  | [[Fine Osteotomes]]                 | `=[[Fine Osteotomes]].location`                 |                                                                                                                    |
>>>
>>>>[!Supply] Supplies
|  #  | Supplies                             | Location                                         | Note |
|:---:| ------------------------------------ | ------------------------------------------------ | ---- |
|  1  | [[Betamethasone Topical Cream 0.1%]] | `=[[Betamethasone Topical Cream 0.1%]].location` |      |
|  1  | [[BSS Irrigating Solution]]          | `=[[BSS Irrigating Solution]].location`          |      |
